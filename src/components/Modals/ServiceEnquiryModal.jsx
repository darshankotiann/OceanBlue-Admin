...
const ServiceEnquiryViewModal = ({ setShowModal, showModal }) => {
    ...
    const updateStatus = (e) => {
        ...
        let reqOptions = {
            url: `${process.env.NEXT_PUBLIC_BASE_URL}/bookservice/${showModal?.data?._id}`,
            method: "PATCH",
            headers: headersList,
        }
                ...
                <div class="relative bg-white rounded-lg shadow ">
                    ...
                    <div class="p-4 md:p-5 grid grid-cols-2 gap-x-4 gap-y-2">
                        ...
                        <div className="w-full flex flex-col gap-2">
                            ...
                            <input value={showModal?.data?.orderID?.productID?.name} readOnly class="w-full bg-gray-50  text-gray-900 text-sm rounded-lg block  p-4 border-2 " />
                        </div>
                        <div className="w-full flex flex-col gap-2">
                            <label class="block w-1/2 items-center text-gray-800   font-medium text-sm">Product Price</label>
                            <input value={showModal?.data?.orderID?.productID?.price} readOnly class="w-full bg-gray-50  text-gray-900 text-sm rounded-lg block  p-4 border-2 " />
                        </div>
...
export default ServiceEnquiryViewModal