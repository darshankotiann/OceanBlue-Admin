        ...
        <>
            <div className="w-1/5 h-screen shadow-1xl ">
                <div className="w-full">
                    ...
                    <div className="p-8">
                        <button type="button" class="flex align-middle focus:outline-none text-white bg-[#0064FF] hover:bg-[#4D70B6] focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">
